...
public class ConeVolume extends AppCompatActivity {
    ...
    public void calculate(View view){
        ...
        if (validate()) {
            ...
            result = (3.1416 * (height * (radius*radius))/3);

            OperationPerformed op = new OperationPerformed(resources.getString(R.string.ConeVolume), resources.getString(R.string.heightValue) + ": " + height + "\n" + resources.getString(R.string.radiusValue) + ": " + radius, result);
            op.save();
